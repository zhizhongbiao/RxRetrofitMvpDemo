//package cn.com.tianyudg.rxretrofitmvpdemo.basic.widget.refresh.smart_refresh;
//
...
// */
//
//public class MyClassicHeader extends RelativeLayout implements RefreshHeader {
...
//    }
//
//    public MyClassicHeader(Context context, AttributeSet attrs, int defStyleAttr) {
//        super(context, attrs, defStyleAttr);
//        this.initView(context, attrs);
//    }
//
//    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
//    public MyClassicHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        mShared = context.getSharedPreferences("MyClassicHeader", Context.MODE_PRIVATE);
...
//        if (getOnPulledProgressListner() != null) {
//            onPulledProgressListner.onPulledProgress(percent, offset);
//        }
//    }
//
//    @Override
...
//    public MyClassicHeader setProgressBitmap(Bitmap bitmap) {
//        mProgressDrawable = null;
//        mProgressView.setImageBitmap(bitmap);
//        return this;
//    }
//
//    public MyClassicHeader setProgressDrawable(Drawable drawable) {
//        mProgressDrawable = null;
//        mProgressView.setImageDrawable(drawable);
//        return this;
//    }
//
//    public MyClassicHeader setProgressResource(@DrawableRes int resId) {
//        mProgressDrawable = null;
//        mProgressView.setImageResource(resId);
//        return this;
//    }
//
//    public MyClassicHeader setArrowBitmap(Bitmap bitmap) {
//        mArrowDrawable = null;
//        mArrowView.setImageBitmap(bitmap);
//        return this;
//    }
//
//    public MyClassicHeader setArrowDrawable(Drawable drawable) {
//        mArrowDrawable = null;
//        mArrowView.setImageDrawable(drawable);
//        return this;
//    }
//
//    public MyClassicHeader setArrowResource(@DrawableRes int resId) {
//        mArrowDrawable = null;
//        mArrowView.setImageResource(resId);
//        return this;
//    }
//
//    public MyClassicHeader setLastUpdateTime(Date time) {
//        mLastTime = time;
...
//    }
//
//    public MyClassicHeader setLastUpdateText(CharSequence text) {
//        mLastTime = null;
//        mLastUpdateText.setText(text);
//        return this;
//    }
//
//    public MyClassicHeader setTimeFormat(DateFormat format) {
//        mFormat = format;
//        if (mLastTime != null) {
...
//    }
//
//    public MyClassicHeader setSpinnerStyle(SpinnerStyle style) {
//        this.mSpinnerStyle = style;
//        return this;
//    }
//
//    public MyClassicHeader setPrimaryColor(@ColorInt int primaryColor) {
...
//    }
//
//    public MyClassicHeader setAccentColor(@ColorInt int accentColor) {
...
//    }
//
//    public MyClassicHeader setPrimaryColorId(@ColorRes int colorId) {
//        setPrimaryColor(ContextCompat.getColor(getContext(), colorId));
//        return this;
//    }
//
//    public MyClassicHeader setAccentColorId(@ColorRes int colorId) {
//        setAccentColor(ContextCompat.getColor(getContext(), colorId));
//        return this;
//    }
//
//    public MyClassicHeader setFinishDuration(int delay) {
//        mFinishDuration = delay;
//        return this;
//    }
//
//    public MyClassicHeader setEnableLastTime(boolean enable) {
...
//    }
//
//    public MyClassicHeader setTextSizeTitle(float size) {
...
//    }
//
//    public MyClassicHeader setTextSizeTitle(int unit, float size) {
...
//    }
//
//    public MyClassicHeader setTextSizeTime(float size) {
...
//    }
//
//    public MyClassicHeader setTextSizeTime(int unit, float size) {
...
//    }
//
//    public MyClassicHeader setTextTimeMarginTop(float dp) {
//        return setTextTimeMarginTopPx(DensityUtil.dp2px(dp));
//    }
//
//    public MyClassicHeader setTextTimeMarginTopPx(int px) {
...
//    }
//
//    public MyClassicHeader setDrawableMarginRight(float dp) {
//        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
//    }
//
//    public MyClassicHeader setDrawableMarginRightPx(int px) {
...
//    }
//
//    public MyClassicHeader setDrawableSize(float dp) {
//        return setDrawableSizePx(DensityUtil.dp2px(dp));
//    }
//
//    public MyClassicHeader setDrawableSizePx(int px) {
...
//    }
//
//    public MyClassicHeader setDrawableArrowSize(float dp) {
//        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
//    }
//
//    public MyClassicHeader setDrawableArrowSizePx(int px) {
//        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
//        lpArrow.width = px;
//        lpArrow.height = px;
//        mArrowView.setLayoutParams(lpArrow);
...
//    }
//
//    public MyClassicHeader setDrawableProgressSize(float dp) {
//        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
//    }
//
//    public MyClassicHeader setDrawableProgressSizePx(int px) {
//        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
//        lpProgress.width = px;
...
//
//
//    public interface OnPulledProgressListner {
//        void onPulledProgress(float percent, int offset);
//    }
//
//    private OnPulledProgressListner onPulledProgressListner;
//
//    public OnPulledProgressListner getOnPulledProgressListner() {
//        return onPulledProgressListner;
//    }
//
//    public void setOnPulledProgressListner(OnPulledProgressListner onPulledProgressListner) {
//        this.onPulledProgressListner = onPulledProgressListner;
//    }
//}
