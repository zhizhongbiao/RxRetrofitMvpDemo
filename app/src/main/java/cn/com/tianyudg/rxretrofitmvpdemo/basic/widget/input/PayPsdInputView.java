package cn.com.tianyudg.rxretrofitmvpdemo.basic.widget.input;
...
public class PayPsdInputView extends EditText {
    ...
    private OnInputPositionListener onInputPositionListener;
...
//       super.onDraw(canvas);
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (onInputPositionListener != null) {
            onInputPositionListener.onInputPosition(this,textLength);
        }
    ...
    public void setOnInputPositionListener(OnInputPositionListener listener) {

        this.onInputPositionListener = listener;
    }

    public interface OnInputPositionListener {
        void onInputPosition(PayPsdInputView inputView, int position);
    }
}
