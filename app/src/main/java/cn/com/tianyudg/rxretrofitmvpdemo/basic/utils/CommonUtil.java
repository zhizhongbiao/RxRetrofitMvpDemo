...
public class CommonUtil {
    ...
    public static String price(Object price) {
     ...
     * @return
     */
    public static SpannableString setPriceSizeTwo(String price) {
        SpannableString  spanString = new SpannableString(price);
        AbsoluteSizeSpan span       = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(22));
//        spanString.setSpan(span, 0, 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        span = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(30));
        spanString.setSpan(span, 1, price.indexOf(".") + 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        span = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(22));
        spanString.setSpan(span, price.indexOf(".") + 2, spanString.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        return spanString;
    }
     ...
     * @return
     */
    public static SpannableString setPriceSize(String price) {
        SpannableString  spanString = new SpannableString("￥" + price);
        AbsoluteSizeSpan span       = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(22));
        spanString.setSpan(span, 0, 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        span = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(30));
     ...
     * @return
     */
    public static SpannableString setPriceSize(String price, int size) {
        SpannableString  spanString = new SpannableString("￥" + price);
        AbsoluteSizeSpan span       = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(size-8));
        spanString.setSpan(span, 0, 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        span = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(size));
        spanString.setSpan(span, 1, price.indexOf(".") + 1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        span = new AbsoluteSizeSpan(AutoUtils.getPercentWidthSize(size-8));
        spanString.setSpan(span, price.indexOf(".") + 2, spanString.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        return spanString;
    }
    ...
    public static String appendString(String... value) {
